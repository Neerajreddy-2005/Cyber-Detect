...
const Home = () => {
  return (
    <div className="flex flex-col w-full">
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-cyberdetect-darker to-cyberdetect-dark py-20 px-4">
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 space-y-8">
            <h1 className="text-4xl md:text-6xl font-bold leading-tight">
              Secure Your Network with <span className="cyber-heading">Cyber-Detect</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild size="lg" className="bg-cyberdetect-purple hover:bg-cyberdetect-purple/90">
                <Link to="/dashboard">View Dashboard</Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="border-cyberdetect-purple text-cyberdetect-purple hover:bg-cyberdetect-purple/10">
          ...
          <div className="md:w-1/2 mt-10 md:mt-0">
            <div className="relative">
              <div className="absolute -inset-1 bg-cyberdetect-purple/30 rounded-lg blur-xl"></div>
              <div className="relative bg-cyberdetect-darker p-4 rounded-lg border border-cyberdetect-purple/30">
                <img 
      ...
      {/* Stats Section */}
      <section className="py-20 px-4 bg-cyberdetect-darker">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            {[
              ...
              <div key={index} className="cyber-card p-8 transition-transform duration-300 hover:scale-105 hover:-translate-y-2">
                <div className="text-4xl md:text-5xl font-bold text-cyberdetect-purple mb-2">
                  {stat.number}
                </div>
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-cyberdetect-dark border-t border-white/5">
